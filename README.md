...
| 題型 | 說明 | 權重 | 指令範例 | 標準答案 |
|------|------|:----:|----------|----------|
| 朗讀 | 複誦指定句子 | 8 | 請說這句話，知識就是力量。 | 知識就是力量。 |
| 列舉 | 說出 N 種某類事物 | 4 | 請說出三種台灣著名的夜市小吃 | （開放） |
| 數數 | 從 M 數到 N | 3 | 請從一數到六 | 一、二、三、四、五、六 |
| 倒數 | 從 N 倒數到 M | 3 | 請從八倒數到一 | 八、七、六、五、四、三、二、一 |
| 序列 | 說出固定序列（星期/月份/四季等） | 3 | 請說出一週七天 | 星期一、星期二、…、星期日 |
| 複述 | 重複一遍句子（措辭可不同於朗讀） | 3 | 跟著說，天下無難事，只怕有心人。 | 天下無難事，只怕有心人。 |
| 描述 | 場景或事物的短篇描述 | 3 | 用一兩句話描述熱鬧的夜市 | （開放） |
| 問答 | 回答知識型問題 | 3 | 台灣的首都是哪裡？ | 台北 |
| 感受描述 | 描述某種感官或情緒感受 | 2 | 描述吃到酸梅時的味覺感受 | （開放） |
| 比較 | 比較兩樣事物哪個更… | 2 | 夏天和冬天你比較喜歡哪個？ | （開放） |
| 舉例 | 舉一個某類事物的例子 | 2 | 請舉一個台灣傳統節日的例子 | （開放） |
| 說出喜好 | 說出最喜歡／不喜歡的事物 | 2 | 你最喜歡的水果是什麼？ | （開放） |
| 反義詞 | 說出指定詞的反義詞 | 1 | 「快樂」的反義詞是什麼？ | 悲傷 |
| 同義詞 | 說出指定詞的同義詞 | 1 | 請說一個「漂亮」的同義詞 | 美麗 |
